function setup() {
  ...
  function draw() {
    ...
    // Funzione per disegnare forme geometriche in bianco e nero
    function drawShapes(x, y, size) {
      let shapeType = int(random(3));
      let colorChoice = random(1) < 0.5 ? color(0) : color(255); // Bianco e nero
      fill(colorChoice); // Colori specificati
